...
Write-Host -ForegroundColor Yellow "videa budou se zvukem"
...
$out_array += "play_all.exe" # stimto nazvem to bude zkompilovany a pak v davce zavola toto a vlastne se akualizuje
