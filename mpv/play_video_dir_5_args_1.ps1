...
#$path = "C:\Users\DELL\Videos\okita\"
#$path = "C:\Users\DELL\Videos\expand\"
#$path = "C:\Users\DELL\Videos\dasa_videa\"
...
echo "pocet videi v adresari je : $d_files"
sleep 3

foreach($file in $files){

"Playing $($file.BaseName)" 
& $mpv "-fs" "--osdlevel=3" "--osd-font-size=20" "--mute" "$file" # musi bejt takle "--fs"
sleep 1
}
