...
Write-Host -ForegroundColor Yellow "videa budou BEZ zvuku a bude 33 % puvodni rychlost"
...
$out_array += "play_all_mute_33_procent_speed.exe" # stimto nazvem to bude zkompilovany a pak v davce zavola toto a vlastne se akualizuje
# a spusti se uz s aktualnim seznamem videi ve slozce, drive su muselo napred ruzne aktualizovat a pak spustit davku
# takle se vsechno zjednodusuje, soubor *.exe pak nakopirovat nekam do cesty PATH a nebo treba do adrease Windowse
...
$out_file_name = "_play_all_mute_33.bat"
